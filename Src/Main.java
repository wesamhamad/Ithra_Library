...
public class Main {
    ...
    private static bookReviews r;// concepts used: ch8&10: - composition & static filed & final
    ...
    public static void main(String[] args) {
        ...
        // Create Date object which is return date
        DateOfBorrowed[ENDDATE] = new Date(y, m, d);
        User customer2 = new User("Student",DateOfBorrowed, "Notes For Professionals",381, "Betool", "0555444444","Mada",r );
